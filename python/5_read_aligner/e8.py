...
# 
# by Moyaccercchi, 27th Jan 2015
# 
# version 8:
# made k an input variable instead of a constant
# 
...
def align_reads(reference, suffix_array, freads, d, k, plen):
...
res = strarraytostring(align_reads(reference, suffix_array, freads, d, k, plen))
