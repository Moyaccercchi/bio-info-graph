...
# 
# by Moyaccercchi, 18th May 2015
# 
# version 12:
# added pigeonhole algorithm for BWT
# 
...
def pigeonholeBWT(Pattern, Text, d, k, suffix_array, BWT, numBWT, firstCol, numfirstCol, plen):
    ...
    for i in range(1, parts+1):
        ...
        print('first: ', firstRow, ' last: ', lastRow)
        ...
        if lastRow > -1:
            for currow in range(firstRow, lastRow+1):
                # (analysis)
                print('lookat: ', currow, suffix_array[currow], suffix_array[currow] - j, j)
