...
def align_reads(referencepath, suffix_array, freads, d, k, plen):
...
res = strarraytostring(align_reads(referencepath, suffix_array, freads, d, k, plen))
