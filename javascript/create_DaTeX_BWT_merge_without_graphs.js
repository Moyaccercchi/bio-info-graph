...
function create_cyclic_rotations(ha, offset) {
	...
	for (var i = 0; i < ha.length; i++) {
		...
		aout.push(ha.slice(i).concat(ha.slice(0, i)).concat(['      ', i+offset]));
	}
...
function example() {
	return create_DaTeX_BWT_merge('ACCA', 'CAAA');
}